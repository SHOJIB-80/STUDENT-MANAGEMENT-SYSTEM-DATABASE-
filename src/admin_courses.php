        ...
        <tr>
            ...
            <td>
                <form method="post" action="server.php" style="display:inline;">
                    ...
                    <button type="submit" name="delete_course" class="btn" style="background-color: #dc3545; padding: 5px 10px; font-size: 12px;" onclick="return confirm('Are you sure you want to delete this course?');">Delete</button>
                </form>
            </td>
        </tr>
        <?php endwhile; else: ?>
