    ...
    <?php  if (isset($_SESSION['username'])) : ?>
    	...
    	<div style="margin: 20px 0;">
    		...
    		<ul style="list-style-type: none; padding: 0;">
				...
				<?php else: ?>
					<!-- Student Menu -->
					<li><a href="courses.php" style="display: block; padding: 10px; margin: 5px 0; background: #17a2b8; color: white; text-decoration: none; border-radius: 4px;">Courses / Enroll</a></li>
