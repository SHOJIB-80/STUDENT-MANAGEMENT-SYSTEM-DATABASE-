...
<div class="enrollments-wrapper">
    ...
    if ($result && $result->num_rows > 0) {
        ...
        print "<tr><th style='width:12%;'>Student ID</th><th style='width:15%;'>Student Name</th><th style='width:20%;'>Course</th><th style='width:12%;'>Faculty</th><th style='width:10%;'>Status</th><th style='width:8%;'>Grade</th><th style='width:15%;'>Enrolled Date</th><th style='width:18%;'>Assign Grade</th></tr>";
